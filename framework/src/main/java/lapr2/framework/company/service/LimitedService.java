...
/**
 * Represents a limited service, an implementation of the {@link Service}.
 *
 * @author flow
 */
@AllArgsConstructor
public class LimitedService implements Service {
	...
	public String toString() {
		return String.format("%s - %s (limited)", id, briefDescription);
	}
	...
	public boolean equals(Object o) {
		...
		LimitedService that = (LimitedService) o;
